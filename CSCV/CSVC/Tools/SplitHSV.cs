...
{
    public partial class SplitHSV : Tool
    {
        ...
        public override void SpecialBitmapUpdate()
        {
            ...
            ImageAlgorithms.HSV_R(ref t, ref this._SpecialBitmapA);
        }
        ...
        public override ImageData SpecialBitmapGet(NodeHandleOut sender)
        {
            ...
            var st = new SectType[] { SectType.HSV_H, SectType.HSV_S, SectType.HSV_V };
