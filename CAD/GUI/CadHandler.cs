    ...
    public partial class CadHandler : UserControl
    {
        ...
        private void checkedListBox1_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (co != null)
                {
                    if (co._Color == null) co._Color = new ColorGL();
                    ns[0].Value = (decimal)co._Color._Ambient[0];
                    ns[1].Value = (decimal)co._Color._Ambient[1];
                    ns[2].Value = (decimal)co._Color._Ambient[2];
                    ns[3].Value = (decimal)co._Color._Ambient[3];
                    ns[4].Value = (decimal)co._Color._Diffuse[0];
                    ns[5].Value = (decimal)co._Color._Diffuse[1];
                    ns[6].Value = (decimal)co._Color._Diffuse[2];
                    ns[7].Value = (decimal)co._Color._Diffuse[3];
                    ns[8].Value = (decimal)co._Color._Emission[0];
                    ns[9].Value = (decimal)co._Color._Emission[1];
                    ns[10].Value = (decimal)co._Color._Emission[2];
                    ns[11].Value = (decimal)co._Color._Emission[3];
                    ns[12].Value = (decimal)co._Color._Specular[0];
                    ns[13].Value = (decimal)co._Color._Specular[1];
                    ns[14].Value = (decimal)co._Color._Specular[2];
                    ns[15].Value = (decimal)co._Color._Specular[3];
                    ns[16].Value = (decimal)co._Color._Shininess[0];
                }
            }
        ...
        private void numericUpDownMat_ValueChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (co._Color == null) co._Color = new ColorGL();
                    co._Color._Ambient[0] = (float)ns[0].Value;
                    co._Color._Ambient[1] = (float)ns[1].Value;
                    co._Color._Ambient[2] = (float)ns[2].Value;
                    co._Color._Ambient[3] = (float)ns[3].Value;
                    co._Color._Diffuse[0] = (float)ns[4].Value;
                    co._Color._Diffuse[1] = (float)ns[5].Value;
                    co._Color._Diffuse[2] = (float)ns[6].Value;
                    co._Color._Diffuse[3] = (float)ns[7].Value;
                    co._Color._Emission[0] = (float)ns[8].Value;
                    co._Color._Emission[1] = (float)ns[9].Value;
                    co._Color._Emission[2] = (float)ns[10].Value;
                    co._Color._Emission[3] = (float)ns[11].Value;
                    co._Color._Specular[0] = (float)ns[12].Value;
                    co._Color._Specular[1] = (float)ns[13].Value;
                    co._Color._Specular[2] = (float)ns[14].Value;
                    co._Color._Specular[3] = (float)ns[15].Value;
                    co._Color._Shininess[0] = (float)ns[16].Value;
                }
            }
        }
